...
# Model Train
result = model.train(data=img_path, epochs=40, cache=True, imgsz=480, project=save_model_path)

# BGR Model Train
result_bgt = model_BGR.train(data=img_bgr_path, epochs=40, cache=True, imgsz=480, project=save_bgr_model_path)